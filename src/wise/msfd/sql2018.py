...
t_V_ART11_Strategies_2020 = Table(
    'V_ART11_Strategies_2020', metadata,
    Column('CountryCode', Unicode(2), nullable=False),
    Column('ReportingDate', Date, nullable=False),
    Column('ReportedFileLink', Unicode(350), nullable=False),
    Column('RelationshipToCA', Unicode(1000)),
    Column('PublicConsultationDates', Unicode(20), nullable=False),
    Column('PublicConsultationSite', Unicode(250), nullable=False),
    Column('RegionalCooperation', Unicode(2500), nullable=False),
    Column('IdReportedInformation', Integer, nullable=False),
    Column('ResponsibleCompetentAuthority', Unicode),
    Column('ResponsibleOrganisations', Unicode),
    Column('Descriptor', Unicode(10)),
    Column('MonitoringStrategyDescription', Unicode),
    Column('Coverage_GEScriteria', Unicode(150)),
    Column('Coverage_Targets', Unicode(150)),
    Column('Coverage_Measures', Unicode(150)),
    Column('Gaps_Plans', Unicode(2500)),
    Column('MonitoringProgrammes', Unicode),
    Column('SubRegions', Unicode),
    Column('RelatedMeasures', Unicode),
    Column('RelatedTargets', Unicode)
)


t_V_ART11_Strategies_Programmes_2020 = Table(
    'V_ART11_Strategies_Programmes_2020', metadata,
    Column('CountryCode', Unicode(2), nullable=False),
    Column('ReportingDate', Date, nullable=False),
    Column('ReportedFileLink', Unicode(350), nullable=False),
    Column('RelationshipToCA', Unicode(1000)),
    ...
    Column('RelatedMeasures', Unicode),
    Column('RelatedTargets', Unicode),
    Column('P_ProgrammeCode', Unicode(50), nullable=False),
    Column('P_ProgrammeName', Unicode(250), nullable=False),
    Column('P_OldProgrammeCodes', Unicode),
    Column('P_UpdateType', Unicode(100), nullable=False),
    Column('P_ProgrammeDescription', Unicode),
    Column('P_OtherPoliciesConventions', Unicode),
    Column('P_RegionalCooperation_coordinations', Unicode),
    Column('P_RegionalCooperation_countries', Unicode),
    Column('P_RegionalCooperation_implementation', Unicode(150)),
    Column('P_TemporalScope', Unicode(9)),
    Column('P_SpatialScopes', Unicode),
    Column('P_MarineReportingUnits', Unicode),
    Column('P_MonitoringPurposes', Unicode),
    Column('P_MonitoringTypes', Unicode),
    Column('P_MonitoringDetails', Unicode(2500)),
    Column('P_MonitoringMethods', Unicode),
    Column('P_MonitoringMethodOther', Unicode(2500)),
    Column('P_QualityControl', Unicode(2500)),
    Column('P_MonitoringFrequency', Unicode(15)),
    Column('P_DataManagement', Unicode(2500)),
    Column('P_DataAccess', Unicode),
    Column('P_RelatedIndicators', Unicode),
    Column('P_Contact', Unicode(2500)),
    Column('P_References', Unicode(2500)),
    Column('Feature', Unicode(50)),
