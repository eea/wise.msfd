...
DISPLAY_LABELS = {
    'ALL': {
        ...
        'SumInfo1': 'Summary information',
        'SumInfo1Unit': 'Summary information unit',
        'SumInfo1Confidence': 'Summary information confidence',
        'SummaryInformation1': 'Summary information',
        'SummaryInformation1Unit': 'Summary information unit',
        'SummaryInformation1Confidence': 'Summary information confidence',
        'Impact5': 'Impact 5',
        'Impact4': 'Impact 4',
        'Impact3': 'Impact 3',
        'Impact2': 'Impact 2',
        ...
        # Article 8 2024 - V_ART8_GES_2024
        'ComponentMRUs': 'Component MRUs',
        'Region_Art4': 'Region (Art 4)',
        'Region_Art8': 'Region (Art 8)',
        'GESachievedDate': 'GES achieved date',
        ...
        'IntegrationRuleDescriptionCriteria': 'Integration rule description (criteria)',
        'IntegrationRuleTypeParameter': 'Integration rule type (parameter)',
        'IntegrationRuleDescriptionParameter': 'Integration rule description (parameter)',
        'SourceAssessmentFeature': 'Source assessment feature',
        'ReportingMethodFeature': 'Reporting method feature',
        'TrendFeature': 'Trend feature',
        ...
        'ElementExtent': 'Element extent',
        'TrendElement': 'Trend element',
        'CriteriaStatus': 'Criteria status',
        'DescriptionCriteria': 'Description criteria',
        'ThresholdValueUpper': 'Threshold value upper',
        'ThresholdValueLower': 'Threshold value lower',
        'ThresholdQualitative': 'Threshold qualitative',
        'ThresholdValueSource': 'Threshold value source',
        'ValueAchievedUpper': 'Value achieved upper',
        'ValueAchievedLower': 'Value achieved lower',
        'ValueUnit': 'Value unit',
        'ProportionThresholdValue': 'Proportion threshold value',
        'ProportionThresholdValueUnit': 'Proportion threshold value unit',
        'ProportionValueAchieved': 'Proportion value achieved',
        'TrendParameter': 'Trend parameter',
        'ParameterAchieved': 'Parameter achieved',
        'DescriptionParameter': 'Description parameter',
        'IndicatorCode': 'Indicator code',
        'ThresholdValueOperator': 'Threshold value operator',
        # Article 19.3
