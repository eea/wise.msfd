...
@provider(IVocabularyFactory)
@db.use_db_session('2024')
def a2024_ges_component_a10(context):
    """GES Component vocabulary for Article 10 2024"""
    parent = context
...
@provider(IVocabularyFactory)
@db.use_db_session('2024')
def a2024_feature_a10(context):
    """Feature vocabulary for Article 10 2024"""
    parent = context
    if not hasattr(parent, 'mapper_class'):
        parent = context.context
...
@provider(IVocabularyFactory)
@db.use_db_session('2024')
def a2024_marine_reporting_unit_a10(context):
    """Marine Reporting Unit vocabulary for Article 10 2024"""
    if hasattr(context, 'subform'):
        context = context.subform
